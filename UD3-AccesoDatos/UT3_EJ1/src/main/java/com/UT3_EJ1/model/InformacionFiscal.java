 ...
 * <p>
 * Esta entidad actúa como la entidad "padre" o fuerte en la relación 1:1 con {@link Cliente}.
 * Sin embargo, a nivel de negocio, es inseparable del cliente. Contiene los datos legales
 ...
 * <li>Esta entidad debe persistirse antes que la entidad {@link Cliente} si se gestionan manualmente,
 * aunque el {@code CascadeType} en Cliente suele facilitar esto.</li>
 * </ul>
 * </p>
 *
...
public class InformacionFiscal {
	 ...
	 * <p>Es la clave primaria de esta entidad y se utiliza para identificar de manera única
	 * la información fiscal. No es autogenerada, debe ser suministrada externamente.</p>
	 */
	@Id
	 ...
	 * <p>Campo obligatorio para la facturación.</p>
	 */
	 ...
	 * <p>Campo obligatorio, longitud máxima 20 caracteres.</p>
	 */
	 ...
	 * <p>Relación uno a uno. Se utiliza carga perezosa (LAZY) para no recuperar los datos
	 * del cliente a menos que sea necesario. Las operaciones de persistencia y fusión se propagan.</p>
	 */
	 ...
	 * <p>Si el valor es nulo, se establece una cadena vacía para evitar nulos en BD.</p>
	 ...
	 * <p>
	 * Valida que sea un teléfono válido: opcional '+' al inicio, solo dígitos al final,
	 * longitud entre 9 y 15 dígitos. Los caracteres no numéricos se eliminan.
	 * </p>
	 *
	...
	public void setTelefono(String telefono) {
	    ...
	    if (lengthSinMas < 9 || lengthSinMas > 15) {
	        throw new IllegalArgumentException(
	            "El teléfono debe tener entre 9 y 15 dígitos (sin contar '+')");
	    }
