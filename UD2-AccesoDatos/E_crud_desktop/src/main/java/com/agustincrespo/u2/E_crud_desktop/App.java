package com.agustincrespo.u2.E_crud_desktop;
...
import com.agustincrespo.u2.E_crud_desktop.persistence.ConnectionFactory;
import com.agustincrespo.u2.E_crud_desktop.persistence.UsuariosPersistence;
...
public class App {
	...
	public static void main(String[] args) {
		...
		try {
			...
			userConPerfil = new Usuario(0, "nuevo_usuario_1", "conperfil@ejemplo.com", "pass123", null, true);
			...
			userSinPerfil = new Usuario(0, "nuevo_usuario_2", "sinperfil@ejemplo.com", "pass456", null, true);
			...
			// TODO Asegurarse de cerrar el pool de conexiones al finalizar. OJO CON ESTO.
